...
<div class="s-a-f">
    ...
    <div class="saf-c">
        <span class="saf-comment"><?php echo b2_get_icon('b2-chat-smile-2-line'); ?><b v-if="item.data.meta.comment == 0"><?php echo __('参与讨论','b2'); ?></b><b v-else>{{item.data.meta.comment}}<?php echo __('条讨论','b2'); ?></b></span>
    </div>
</div>
