        ...
        <div class="shop-normal-item-info shop-exchange-item-info">
            ...
            <div class="shop-normal-item-price">
                ...
                <div class="shop-normal-item-right">
                    <button :disabled="data !== '' && !data[<?php echo $post_id; ?>].can_buy.allow" v-text="data !== '' ? data[<?php echo $post_id; ?>].can_buy.text : '<?php echo __('抽奖','b2'); ?>'" @click="go('<?php echo get_permalink($post_id); ?>')"></button>
                </div>
            </div>
            ...
            <div class="shop-normal-item-count">
                ...
                <span v-show="data !== '' && data[<?php echo $post_id; ?>].stock.sell !== ''" v-cloak><?php echo __('抽中：','b2'); ?><b v-if="data === ''">--</b><b v-else v-text="data[<?php echo $post_id; ?>].stock.sell"></b></span>
