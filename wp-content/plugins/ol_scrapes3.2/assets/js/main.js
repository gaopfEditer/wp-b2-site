	...
	.controller('options', function(
		...
		$scope.set_header = function () {
			...
			$(document).on('click', header + ' ul li a', function (event) {
				var panel = $(this.hash);
				var collapsed = panel.find('.collapse').hasClass('in');

				event.preventDefault();

				if (collapsed) {
					$('html, body').stop(true).animate({
						scrollTop: panel.offset().top - offset + 1
					}, 500);
				} else {
		...
		$scope.add_field = function($event, type) {
					...
					'<div class="form-group" ng-class="{\'has-error\' : form[\'scrape_custom_fields[' + custom_field_id + '][value]\'].$invalid && (form[\'scrape_custom_fields[' + custom_field_id + '][value]\'].$dirty || submitted)}">' +
						...
						'<div class="col-sm-12" ng-show="model.scrape_custom_fields[' + custom_field_id + '].template_status">' +
							...
							'<div class="input-tags">' +
								...
								'<button type="button" class="btn btn-primary btn-xs" data-value=\'[scrape_meta name="name"]\'>' + translate.btn_custom_field + '</button>' +
								'<button type="button" class="btn btn-primary btn-xs" data-value=\'[scrape_url]\'>' + translate.btn_source_url + '</button>' +
								'<button type="button" class="btn btn-primary btn-xs" data-value=\'[affiliate]\'>' + translate.btn_affiliate + '</button>' +
							...
							'<div class="col-sm-12">' +
								...
								'<div class="form-group">' +
									'<div class="col-sm-12">' +
										...
										'<div class="checkbox"><label><input type="checkbox" name="scrape_custom_fields[' + custom_field_id + '][dont_update]" ng-model="model.scrape_custom_fields[' + custom_field_id + '].dont_update"> ' + translate.enable_dont_update + '</label></div>' +
									'</div>' +
								'</div>' +
							'</div>' +
						'</div>' +
			...
			if (type == 'category_regex') {
				var category_regex_id = $($event.target).closest('.form-group').attr('ng-show').split(/[\[\]]/)[1];
				$($event.target).closest('.form-group').before($compile(
					'<div class="form-group" ng-show="model.scrape_categoryxpath_tax[' + category_regex_id + '].tax_name && model.scrape_categoryxpath_tax[' + category_regex_id + '].regex_status">' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.find + '</div>' +
								'<input type="text" name="scrape_categoryxpath_tax[' + category_regex_id + '][regex_finds][]" placeholder="' + translate.eg_find + '" class="form-control">' +
								'<span class="input-group-btn"><button type="button" class="btn btn-primary btn-block" ng-click="remove_field($event)"><i class="icon ion-trash-a"></i></button></span>' +
							'</div>' +
						'</div>' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.replace + '</div>' +
								'<input type="text" name="scrape_categoryxpath_tax[' + category_regex_id + '][regex_replaces][]" placeholder="' + translate.eg_replace + '" class="form-control">' +
							'</div>' +
						'</div>' +
					'</div>'
				)($scope));
			...
			if (type == 'taxonomy_field') {
				var taxonomy_field_id = new Date().getTime();
				$($event.target).closest('.form-group').before(
					'<div class="form-group" ng-class="{\'has-error\' : form[\'scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]\'].$invalid && (form[\'scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]\'].$dirty || submitted)}">' +
						'<div class="col-sm-12">' +							
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.Taxonomy + '</div>' +
								'<div class="select">' +
									'<select name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][name]" class="form-control" ng-model="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].tax_name">' +
							...
							'</div>' +
						'</div>' +						
						'<div class="form-group" ng-if="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].tax_name">' +
							'<div class="col-sm-12">' +
								'<div class="input-group">' +
									'<div class="input-group-addon">' + translate.value + '</div>' +
									'<input type="text" name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]" placeholder="' + translate.xpath_placeholder + '" class="form-control" ng-model="model[\'scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]\']" ng-pattern="/^///">' +
									'<span class="input-group-btn"><button type="button" class="btn btn-primary btn-block" ng-click="show_iframe_single($event)"><i class="icon ion-android-locate"></i></button></span>' +
								'</div>' +
								'<p class="help-block" ng-show="form[\'scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]\'].$invalid && (form[\'scrape_categoryxpath_tax[' + taxonomy_field_id + '][value]\'].$dirty || submitted)">' + translate.enter_valid + '</p>' +
							'</div>' +
							'<div class="col-sm-12">' +
								'<div class="input-group">' +
									'<div class="input-group-addon">' + translate.separator + '</div>' +
									'<input type="text" name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][separator]" placeholder="' + translate.eg_comma + '" class="form-control" ng-model="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].separator">' +
								'</div>' +
							'</div>' +
							'<div class="col-sm-12" ng-show="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].template_status">' +
								'<div class="input-group">' +
									'<div class="input-group-addon">' + translate.template + '</div>' +
									'<input type="text" name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][template]" placeholder="' + translate.eg_scrape_value + '" class="form-control">' +
								'</div>' +
								'<div class="input-tags">' +
									'<button type="button" class="btn btn-primary btn-xs" data-value=\'[scrape_value]\'>' + translate.btn_value + '</button>' +
								'</div>' +
							'</div>' +							
						'</div>' +						
						'<div class="form-group" ng-show="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].tax_name && model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].regex_status">' +
							'<div class="col-sm-12">' +
								'<button type="button" class="btn btn-link" ng-click="add_field($event, \'category_regex\')"><i class="icon ion-plus-circled"></i> ' + translate.add_new_replace + '</button>' +
							'</div>' +
						'</div>' +
						'<div class="form-group" ng-show="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].tax_name">' +
							'<div class="col-sm-12">' +
								'<div class="checkbox"><label><input type="checkbox" name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][template_status]" ng-model="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].template_status"> ' + translate.enable_template + '</label></div>' +
								'<div class="checkbox"><label><input type="checkbox" name="scrape_categoryxpath_tax[' + taxonomy_field_id + '][regex_status]" ng-model="model.scrape_categoryxpath_tax[' + taxonomy_field_id + '].regex_status">' + translate.enable_find_replace + '</label></div>' +
							'</div>' +
						'</div>' +	
					'</div>'				
				);
				...
				$compile($($event.target).closest('.form-group').prev())($scope);
				$scope.set_taxonomy_field_name_auto_complete(taxonomy_field_id);
			}			
			...
			if (type == 'featured_regex') {
				$($event.target).closest('.form-group').before($compile(
					'<div class="form-group" ng-show="model.scrape_featured_regex_status && model.scrape_featured_type == \'xpath\'">' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.find + '</div>' +
								'<input type="text" name="scrape_featured_regex_finds[]" placeholder="' + translate.eg_find + '" class="form-control">' +
								'<span class="input-group-btn"><button type="button" class="btn btn-primary btn-block" ng-click="remove_field($event)"><i class="icon ion-trash-a"></i></button></span>' +
							'</div>' +
						'</div>' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.replace + '</div>' +
								'<input type="text" name="scrape_featured_regex_replaces[]" placeholder="' + translate.eg_replace + '" class="form-control">' +
							'</div>' +
						'</div>' +
					'</div>'
				)($scope));
			...
			if (type == 'nextpage_parameter') {
				$($event.target).closest('.form-group').before($compile(
					'<div class="form-group" ng-show="model.scrape_nextpage_type == \'parameter\'">' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.name + '</div>' +
								'<input type="text" name="scrape_next_page_url_parameters_names[]" placeholder="' + translate.eg_name + '" class="form-control">' +
								'<span class="input-group-btn"><button type="button" class="btn btn-primary btn-block" ng-click="remove_field($event)"><i class="icon ion-trash-a"></i></button></span>' +
							'</div>' +
						'</div>' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.value + '</div>' +
								'<input type="text" name="scrape_next_page_url_parameters_values[]" placeholder="' + translate.eg_1 + '" class="form-control">' +
							'</div>' +
						'</div>' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.increment + '</div>' +
								'<input type="text" name="scrape_next_page_url_parameters_increments[]" placeholder="' + translate.eg_1 + '" class="form-control">' +
							'</div>' +
						'</div>' +
					'</div>'
				)($scope));
			...
			if (type == 'filter') {
				$($event.target).closest('.form-group').before($compile(
					'<div class="form-group">' +
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.Operator + '</div>' +
								'<div class="select">' +
									'<select name="scrape_filters_operators[]" class="form-control">' +
										'<option value="contains">' + translate.Contains + '</option>' +
										'<option value="does_not_contain">' + translate.Does_not_contain + '</option>' +
										'<option value="exists">' + translate.Exists + '</option>' +
										'<option value="not_exists">' + translate.Not_exists + '</option>' +
										'<option value="equal_to">' + translate.Equal_to + '</option>' +
										'<option value="not_equal_to">' + translate.Not_equal_to + '</option>' +
										'<option value="greater_than">' + translate.Greater_than + '</option>' +
										'<option value="less_than">' + translate.Less_than + '</option>' +
									'</select>' +
								'</div>' +
						...
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.Field + '</div>' +
								'<div class="select">' +
									'<select name="scrape_filters_fields[]" class="form-control">' +
										'<option value="title">' + translate.Title + '</option>' +
										'<option value="content" selected>' + translate.Content + '</option>' +
										'<option value="excerpt">' + translate.Excerpt + '</option>' +
										'<option value="featured_image">' + translate.Featured_image + '</option>' +
						...
						'<div class="col-sm-12">' +
							'<div class="input-group">' +
								'<div class="input-group-addon">' + translate.value + '</div>' +
								'<input type="text" name="scrape_filters_values[]"  placeholder="' + translate.eg_value + '" class="form-control">' +
							'</div>' +
						'</div>' +
					'</div>'
				)($scope));
		...
		$scope.update_filters = function(id) {
			if (id) {
				$('[name="scrape_filters_fields[]"]').each(function() {
					if ($(this).val() == 'custom_field_' + id) {
						$(this).closest('.form-group').remove();
					}
					$(this).find('option[value="custom_field_' + id +'"]').remove();
				});
			} else {
				$('[name^="scrape_custom_fields"][name$="[name]"]').each(function() {
					var name = $(this).attr('name');
					var value = $(this).val();
					var id = name.split('scrape_custom_fields[').pop().split('][name]')[0];

					$('[name="scrape_filters_fields[]"]').each(function() {
						if (value !== '') {
							var custom_field = 'custom_field_' + id;
							if (!$(this).find('option[value="' + custom_field + '"]').length > 0) {
								$(this).append('<option value="' + custom_field + '">Custom field - ' + value +'</option>');
							}
						}
					});
				});
		...
		$(document).on('mousedown', '[name="scrape_filters_fields[]"]', function () {
			$scope.update_filters();
		});

		$scope.remove_field = function($event) {
			var input = $($event.target).parents('.input-group').find('[name^="scrape_custom_fields"][name$="[name]"]');
			if (input.length > 0) {
				var id = input.attr('name').split('scrape_custom_fields[').pop().split('][name]')[0];
				$scope.update_filters(id);
			}

			$($event.target).closest('.form-group').remove();
		};

		$scope.set_taxonomy_field_name_auto_complete = function(taxonomy_field_id) {
			...
			$.ajax({
				...
				data: {
					action: 'get_post_tax',
					post_type: $scope.model.scrape_post_type,
					post_id: $('#post_ID').val()
				},
				beforeSend: function() {
				...
				success: function(response) {
					var taxonomies = $('select[name^="scrape_categoryxpath_tax[' + taxonomy_field_id + ']"][name*="[name]"]');
		...
		$scope.update_categories = function(post_type) {
			...
			$scope.set_taxonomy_field_name_auto_complete();
			$scope.set_custom_field_name_auto_complete();
		};
			...
			$scope.$watchCollection(
				...
				function() {
					$timeout(function() {
						...
						// Facebook Mobile Basic - Pages
						else if (/\/mbasic\.facebook\.com(?!\/groups\/)/.test(url)) {
							var cookie_exists  = [];
							var cookies = [
								{name: 'c_user'},
								{name: 'xs'}
							...
							$scope.mfacebook_page_content_xpath = '//div[@data-ft]/div[1] | //div[@id="root"]/div[1]/div[1]/div[1]/div[1]';
							$scope.mfacebook_page_date_xpath = '//abbr';
							...
							if (!$scope.model.scrape_content) {
								...
								$scope.model.scrape_content = $scope.mfacebook_page_content_xpath;
							}

							if (!$scope.model.scrape_date) {
								$scope.model.scrape_date_type = 'xpath';
								$scope.model.scrape_date = $scope.mfacebook_page_date_xpath;
							}

							$scope.special_url = 'mfacebook_page';
						}

						// Facebook Mobile Basic - Groups
						else if (/\/mbasic\.facebook\.com\/groups\//.test(url)) {
							var cookie_exists  = [];
							var cookies = [
								{name: 'c_user'},
							...
							$scope.mfacebook_groups_nextpage_xpath = '//div[@id="m_group_stories_container"]/div[2]/a';
							$scope.mfacebook_groups_content_xpath = '//div[@data-ft]/div[1] | //div[@id="root"]/div[1]/div[1]/div[1]/div[1]';
							$scope.mfacebook_groups_date_xpath = '//abbr';
							...
							if (!$scope.model.scrape_nextpage) {
								$scope.model.scrape_nextpage = $scope.mfacebook_groups_nextpage_xpath;
							}

							if (!$scope.model.scrape_content) {
								$scope.model.scrape_content_type = 'xpath';
								$scope.model.scrape_content = $scope.mfacebook_groups_content_xpath;
							}

							if (!$scope.model.scrape_date) {
								$scope.model.scrape_date_type = 'xpath';
								$scope.model.scrape_date = $scope.mfacebook_groups_date_xpath;
							}

							$scope.special_url = 'mfacebook_groups';
						}
...
(function($)
	...
	$(document).ready(function() {
		...
		function scr_panel_step(step) {
		
			current_step = step;
			var $steps = $('.scr-step');
			
			$steps.removeClass('scr-step-passed');
			for(var i = 0; i <= step; i++) $('.scr-step-'+i).addClass('scr-step-passed');			
		}
		
		function updateItems(delta)
		{
			var $items = $('.panel-group').children();
		...
		$(".next").click(function () {
			...
			if(new_step > 9) new_step = 9;			
			scr_panel_step(new_step);
		...
		$(".scr-step-0").click(function (){
		    $('#panel_jumb').addClass("current");
		    $(".panel").not($('#panel_jumb')).removeClass("current");
		    scr_panel_step(0);
		    topFunction();
		    $(".prev").css("display","none");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-1").click(function (){
		    $('#panel_00').addClass("current");
		    $(".panel").not($('#panel_00')).removeClass("current");
		    scr_panel_step(1);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-2").click(function (){
		    $('#panel_01').addClass("current");
		    $(".panel").not($('#panel_01')).removeClass("current");
		    scr_panel_step(2);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});	
		$(".scr-step-3").click(function (){
		    $('#panel_02').addClass("current");
		    $(".panel").not($('#panel_02')).removeClass("current");
		    scr_panel_step(3);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-4").click(function (){
		    $('#panel_03').addClass("current");
		    $(".panel").not($('#panel_03')).removeClass("current");
		    scr_panel_step(4);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});	
		$(".scr-step-5").click(function (){
		    $('#panel_04').addClass("current");
		    $(".panel").not($('#panel_04')).removeClass("current");
		    scr_panel_step(5);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-6").click(function (){
		    $('#panel_05').addClass("current");
		    $(".panel").not($('#panel_05')).removeClass("current");
		    scr_panel_step(6);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-7").click(function (){
		    $('#panel_06').addClass("current");
		    $(".panel").not($('#panel_06')).removeClass("current");
		    scr_panel_step(7);
		    topFunction();
		    $(".prev").css("display","inline-block");
		    $(".next").css("display","inline-block");
		});
		$(".scr-step-8").click(function (){
		    $('#panel_07').addClass("current");
		    $(".panel").not($('#panel_07')).removeClass("current");
		    scr_panel_step(8);
		    topFunction();
